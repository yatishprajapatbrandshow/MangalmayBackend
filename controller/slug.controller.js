...
const getBySlug = async (req, res) => {
  try {
    ...
    let data = await Slug.findOne({ path, deleteflag: false, status: true }).lean();
    ...
    const finalData = {
      ...
      banner_img: data?.banner_img ? data.type != "BlogDetails" ? imagePath + data?.banner_img :data?.banner_img : false,
      pageData,
